...
public class AudioPlayer
{
    ...
    public AudioPlayer()
    {
        LogService.Log("Starting", "初始化 AudioPlayer.");
    ...
    public async Task SetSourceAsync(MusicData musicData)
    {
        ...
        LogService.Log("AudioPlayer", $"Loaded：\"{musicData}\"");
    }
    ...
    private void CreateOutputDevice(OutDevice device, int latency)
    {
        ...
        {
            case OutApi.WaveOut:
                LogService.Log("AudioPlayer", "Using WaveOut.");
            ...
            case OutApi.DirectSound:
                LogService.Log("AudioPlayer", "Using DirectSound.");
                ...
                break;
            case OutApi.Wasapi:
                LogService.Log("AudioPlayer", "Using Wasapi.");
                ...
                break;
            case OutApi.Asio:
                LogService.Log("AudioPlayer", "Using Asio.");
    ...
    public async void SetReloadAsync(bool autoPlay = false)
    {
        ...
        catch (Exception err) { LogService.Error("AudioPlayer", err.ToString()); }
    }
