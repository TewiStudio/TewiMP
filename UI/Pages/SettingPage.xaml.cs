...
namespace TewiMP.UI.Pages
{
    public partial class SettingPage : Page
    {
        ...
        private async void Button_Click_3(object sender, RoutedEventArgs e)
        {
            ...
            {
                var res = await FileHelper.UserSelectFile(global::Windows.Storage.Pickers.PickerViewMode.List, global::Windows.Storage.Pickers.PickerLocationId.VideosLibrary, new[] { ".mp4", "*" });
                if (res != null)
                {
        ...
        {
            var path = await FileHelper.UserSelectFile(global::Windows.Storage.Pickers.PickerViewMode.Thumbnail, global::Windows.Storage.Pickers.PickerLocationId.PicturesLibrary);
        ...
        private void ToggleSwitch_Loaded_1(object sender, RoutedEventArgs e)
        {
            ...
            {
                toggleSwitch.IsOn = UI.Controls.ImageEx.ImageDarkMass;
            }
        }
        ...
        private void ToggleSwitch_Toggled_3(object sender, RoutedEventArgs e)
        {
            ...
            {
                UI.Controls.ImageEx.ImageDarkMass = toggleSwitch.IsOn;
            }
        }
