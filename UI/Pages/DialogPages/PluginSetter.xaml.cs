...
namespace TewiMP.UI.Pages.DialogPages
{
    ...
    {
        public Services.Plugin.Plugin Plugin { get; set; }
        public PluginSetter()
        {
            InitializeComponent();
        }
    ...
    internal class PluginSetting(Services.Plugin.Plugin plugin, KeyValuePair<string, object> keyValue)
    {
        public Services.Plugin.Plugin Plugin => plugin;
