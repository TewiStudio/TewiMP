...
namespace TewiMP.UI.Pages.DialogPages
{
    public partial class AddPlayListPage : Page
    {
        ...
        public AddPlayListPage()
        {
            ...
            AddOutSidePage_PlatfromCb.ItemsSource = PluginService.MusicSourcePlugins;
        ...
        {
            var a = await FileHelper.UserSelectFile(PickerViewMode.List, PickerLocationId.PicturesLibrary);
            if (a != null)
