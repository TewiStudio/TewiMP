...
public sealed partial class MainWindow : WindowEx
{
    ...
    public MainWindow()
    {
        ...
        LogService.Info(nameof(MainWindow), "Inited");
    }
    ...
    private void UpdateWhenDataLated()
    {
        ...
        LogService.Log(nameof(MainWindow), "Data Updated.");
    }
    ...
    private void AddEvents()
    {
        ...
        LogService.Log(nameof(MainWindow), "Added Events.");
    }
    ...
    private void RemoveEvents()
    {
        ...
        LogService.Log(nameof(MainWindow), "Removed Events.");
    }
    ...
    private void LyricManager_PlayingLyricSelectedChange(LyricData _)
    {
        ...
        {
            LogService.Log(nameof(MainWindow), "LyricManager_PlayingLyricSelectedChange: " + err.Message);
        }
    }
    ...
    {
        //PlayingListBaseView.SelectedItem = App.Instance.AudioService.MusicData;
    }
    ...
    private void AudioService_PlayEnd(AudioService AudioService)
    {
        if (true)
        {
            AudioService_PlayStateChanged(AudioService);
        }
    }

    bool doNotChangeTiming = false;
    private void AudioService_CacheLoadedChanged(AudioService AudioService)
    {
        PlayRing.Value = 0;
    ...
    public void PlayingList_NowPlayingImageLoaded(Uri imageSource, string _)
    {
        ...
        if (imageSource != im.Source)
        {
            ...
            im.SaveName = $"{App.Instance.AudioService.MusicData.Title} · {App.Instance.AudioService.MusicData.Album.Title}";
    ...
    private void AudioService_SourceChanged(AudioService AudioService)
    {
        ...
        if (pointConnectAnimationMusicData == AudioService.MusicData) return;
        pointConnectAnimationMusicData = AudioService.MusicData;
    ...
    private void AudioService_PlayStateChanged(AudioService AudioService)
    {
        ...
        MediaPlayStateViewer.PlaybackState = AudioService.PlaybackState;
    }
    ...
    private void AudioService_TimingChanged(AudioService AudioService)
    {
        ...
        PlayRing.Minimum = 0;
        PlayRing.Maximum = AudioService.TotalTime.Ticks;
        PlayRing.Value = AudioService.CurrentTime.Ticks;
    }
    #endregion
    ...
    private void NavView_SelectionChanged(NavigationView sender, NavigationViewSelectionChangedEventArgs args)
    {
        ...
        else
        {
            ...
            {
                LogService.Log(nameof(MainWindow), "NavigationSelectionChanged: SelectedItem 为 null");
            }
    ...
    #region Key Events
    public delegate void InKeyDown(global::Windows.System.VirtualKey key);
    ...
    private void Grid_KeyDown(object sender, KeyRoutedEventArgs e)
    {
        switch (e.Key)
        {
            case global::Windows.System.VirtualKey.GoBack:
                ...
                break;
            case global::Windows.System.VirtualKey.GoForward:
                TryGoForward();
                break;
            ...
            case global::Windows.System.VirtualKey.Control:
                isControlDown = true;
                break;
            case global::Windows.System.VirtualKey.Shift:
                isShiftDown = true;
                break;
    ...
    private void VolumeSlider_ValueChanged(object sender, Microsoft.UI.Xaml.Controls.Primitives.RangeBaseValueChangedEventArgs e)
    {
        if (willChangeVolume)
        {
            App.Instance.AudioService.Volume = (float)(sender as Slider).Value;
        }
    }
    #endregion
    ...
    {
        if (App.Instance.AudioService.Volume != 0)
        {
            NoVolumeValue = App.Instance.AudioService.Volume;
            App.Instance.AudioService.Volume = 0;
        }
        else
        {
            App.Instance.AudioService.Volume = NoVolumeValue;
        }
    }
    #endregion
    ...
    {/*
        ...
        if (PlayingListBaseView.SelectedItem != null)
        {
            ...
            if (App.Instance.AudioService.MusicData != data)
    ...
    private void AudioService_TimingChanged1(AudioService AudioService)
    {
        if (AudioService.FileReader != null)
        {
            ...
            PlayTimeSlider.Maximum = AudioService.TotalTime.Ticks;
            PlayTimeSlider.Value = AudioService.CurrentTime.Ticks;
            isCodeChangedSilderValue = false;

            PlayTimeTextBlock.Text =
                    $"{AudioService.CurrentTime:mm\\:ss}/{AudioService.TotalTime:mm\\:ss}";
        }
    }
    ...
    {
        if (!isCodeChangedSilderValue && App.Instance.AudioService.FileReader != null)
        {
            App.Instance.AudioService.CurrentTime = TimeSpan.FromTicks((long)PlayTimeSlider.Value);
        }
    }
    #endregion
    ...
    private void RamTimer_Tick(object sender, object e)
    {
        try
        {
            DebugView_Detail_RAM.Text = $"RAM: {(CodeHelper.GetAutoSizeString(global::Windows.System.MemoryManager.AppMemoryUsage, 2))}/{CodeHelper.GetAutoSizeString(GC.GetTotalMemory(false), 2)}";
        }
        catch { }
    }
    ...
    {
        MusicDataFlyout.SongItemBind = new() { MusicData = App.Instance.AudioService.MusicData };
    ...
    {
        protected override global::Windows.UI.Composition.CompositionBrush CreateBrush(global::Windows.UI.Composition.Compositor compositor)
