...
namespace TewiMP.UI.Windows
{
    public partial class ImageViewerWindow : Window
    {
        ...
        private async void Button_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (true)
            {
                targetFile = await FileHelper.UserSaveFile(SaveName is null ? "一张图片" : SaveName, global::Windows.Storage.Pickers.PickerLocationId.PicturesLibrary, [".png", ".gif"], "图片",
        ...
        {
            if (e.Key == global::Windows.System.VirtualKey.Shift)
            {
