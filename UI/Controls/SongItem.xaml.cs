...
*/
        ...
        public void Init(SongItemBindBase bindBase)
        {
            ...
            IsMusicDataPlaying = App.Instance.AudioService.MusicData == MusicData;
        }
        ...
        {
            App.Instance.PlayingListService.SetNextPlay(App.Instance.AudioService.MusicData, MusicData);
        }
